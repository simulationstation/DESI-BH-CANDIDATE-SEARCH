...
def main():
    ...
    print(f"\nInput: {filepath}")
    print(f"Max rows: {'ALL' if args.max_rows is None else f'{args.max_rows:,}'}")
    ...
    # e.g., rvpix_exp-main-bright.fits -> top_candidates_main_bright_full.csv
    input_stem = filepath.stem.replace("rvpix_exp-", "").replace("-", "_")
    output_name = f"top_candidates_{input_stem}_full.csv"
