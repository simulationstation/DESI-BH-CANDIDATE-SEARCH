#!/usr/bin/env python3
"""
Run MCMC orbital fitting on E2_dark_companions candidates and generate detailed reports.
"""
...
OUTPUT_DIR = '/home/primary/DESI-BH-CANDIDATE-SEARCH/detailed_reports_e2'
...
def generate_summary_report(all_results, candidates):
    ...
    report = []
    report.append("# E2_dark_companions MCMC Verification Report")
...
def main():
    print("=" * 70)
    print("E2_dark_companions MCMC Verification")
    print("=" * 70)
    print()

    # Load E1 results
    e1_path = '/home/primary/DESI-BH-CANDIDATE-SEARCH/runs/real_run_20260115_183016/candidates/E2_dark_companions_results.json'
