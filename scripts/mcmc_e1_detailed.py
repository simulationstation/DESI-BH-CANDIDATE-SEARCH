#!/usr/bin/env python3
"""
Run MCMC orbital fitting on E1_mass_gap candidates and generate detailed reports.
"""
...
OUTPUT_DIR = '/home/primary/DESI-BH-CANDIDATE-SEARCH/detailed_reports_e1'
...
def generate_summary_report(all_results, candidates):
    ...
    report = []
    report.append("# E1_mass_gap MCMC Verification Report")
...
def main():
    print("=" * 70)
    print("E1_mass_gap MCMC Verification")
    print("=" * 70)
    print()

    # Load E1 results
    e1_path = '/home/primary/DESI-BH-CANDIDATE-SEARCH/runs/real_run_20260115_183016/candidates/E1_mass_gap_results.json'
